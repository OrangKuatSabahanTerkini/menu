...
if [[ $vps = "zvur" ]]; then
	source="http://vps-keningauseller02.me/Debian7"
else
	source="http://www.borneobesthosting.me"
fi
...
wget -q -O /etc/squid3/squid.conf $source/Debian7/squid3.conf
...
wget "http://vps-keningauseller02.me/Debian7/fstab
mv ./fstab /etc/fstab
chmod 644 /etc/fstab
